...
So I was browsing through _Crux Mathematicorum’s_ [latest issue](https://cms.math.ca/wp-content/uploads/2025/10/Wholeissue_51_8-r2.pdf) and came across this interesting limit problem:
...
Usually _Crux_ does not accept undergraduate-level solutions, so I will discuss one here.

It also happens that I am teaching a probability and statistics course right now. One of the fundamental theorems that connects the theory of probability to the practice of statistics is the _[Central Limit Theorem](https://en.wikipedia.org/wiki/Central_limit_theorem)_. Let me state a simple version of it:
