>A positive integer 𝑛 is called *good* if there is a set of divisors of 𝑛 whose members sum to 𝑛 and include 1. Prove that every positive integer has a multiple, which is good.
